...
This CloudFormation template deploys the complete VPC infrastructure and EC2 instances for a highly available QRadar SIEM deployment on AWS. See [Network Architecture](NETWORK_ARCHITECTURE.md) for details of the infrastructure design.
